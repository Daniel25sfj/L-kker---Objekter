...
//   {
//   }
//   person.title = person.gender === "male" ? "Mr." : "Ms.";
//   {
//   }
//   combinedAge += person.age;
//   count++;
...
//   person.city = cities[randomIndex];
...
// const whitespace = ["This  ", "TEXT" , "NEEDs  ", "CLEAnING"];
// for(let i = 0; i < whitespace.length; i++) {
//   whitespace[i] = whitespace[i].trim().toLowerCase();
// }
// const result = whitespace.join(" ");
...
// for(let i = 0; i < doubleSwap.length; i++){
// doubleSwap[i] = doubleSwap.replaceAll("")
...
const output = doubleSwap("this is a string", "i", "s");
console.log(output);
